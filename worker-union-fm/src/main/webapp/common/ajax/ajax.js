...
function failDefault(data, isExplicit) {
	if (verifyLogin(data, isExplicit) && verifyAuthorization(data, isExplicit)) {
		if (isExplicit) {
...
document.write("<script type='text/javascript' src='" + getContextRoot()
		+ "/common/ajax/ajax_certificate.js'></script>");
document.write("<script type='text/javascript' src='" + getContextRoot()
		+ "/common/ajax/ajax_supplier.js'></script>");
document.write("<script type='text/javascript' src='" + getContextRoot()
	...
	document.write("<script type='text/javascript' src='" + getContextRoot()
			+ "/common/ajax/ajax_material_headquarters.js'></script>");
	document.write("<script type='text/javascript' src='" + getContextRoot()
			+ "/common/ajax/ajax_permission.js'></script>");