 ...
 *
 */
public class UploadUniqueAttachmentServlet extends CallbackServlet {
	...
	private static final Logger LOG = LoggerFactory.getLogger(UploadUniqueAttachmentServlet.class);
	 ...
	 */
	public UploadUniqueAttachmentServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		if (ret) {
			...
			try {
				...
				return;
			} catch (WhAttachmentExistException e) {
				response(request, response,
						"{\"returnCode\":\"FAIL\", \"errorCode\":\"USER_EXCEPTION\", \"errorCodeDesc\":\"该附件已存在\"}",
