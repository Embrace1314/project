...
function btnDeleteFile(obj) {
    if (confirm("确定删除该文件？")) {
        ...
        ajaxRemoveFinalReportAttachmentById(getUrlParam("project.id"), attachmentId, function (data) {
            //刷新列表
            showFileList();
        }, function (data) {
        }, true, waiting, run, true);
...
var uploaderParams = {
    ...
    init: {
        ...
        FilesAdded: function (uploader, files) {
            // 开始上传
            ajaxAcquireFinalReportUpToken(getUrlParam("project.id"), function (data) {
