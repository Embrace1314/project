 ...
 *            缓冲是否显示处理
 */
function ajaxProjectLogin(projectId, success, fail, isExplicit, waiting, run,
							isLoadingExplicit) {
	// 显示缓冲
	if (isLoadingExplicit) {
		waiting();
 ...
 *            缓冲是否显示处理
 */
function ajaxGetProjectDetailById(projectId, success, fail, isExplicit, waiting, run,
		isLoadingExplicit) {
	// 显示缓冲
	if (isLoadingExplicit) {
		waiting();
