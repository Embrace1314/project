 ...
 *            缓冲是否显示处理
 */
function ajaxGetTargetUniqueAttachment(projectId, success, fail, isExplicit, waiting, run,
                                              isLoadingExplicit) {
    // 显示缓冲
 ...
 *            缓冲是否显示处理
 */
function ajaxGetTargetDetail(projectId, success, fail, isExplicit, waiting, run,
                                       isLoadingExplicit) {
    // 显示缓冲
    if (isLoadingExplicit) {
        waiting();
