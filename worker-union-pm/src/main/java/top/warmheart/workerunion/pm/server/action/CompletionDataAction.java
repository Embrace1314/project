...
@Scope("prototype")
public class CompletionDataAction extends ActionJson {
	...
	public String removeAttachmentById() throws Exception {
		...
		if (!Attachment.TYPE_COMPLETION_DATA.equalsIgnoreCase(attachmentDtoCheck.getType())) {
	...
	public String listAttachment() throws Exception {
		...
		// 查找附件信息
		List<AttachmentDto> attachmentCheck = attachmentService.listAuditAttachment(project.getId(), Attachment.TYPE_COMPLETION_DATA);
