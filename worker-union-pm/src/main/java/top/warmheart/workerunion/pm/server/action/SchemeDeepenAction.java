...
@Scope("prototype")
public class SchemeDeepenAction extends ActionJson {
	...
	public String removeAttachmentById() throws Exception {
		...
		if (!Attachment.TYPE_SCHEME_DEEPEN.equalsIgnoreCase(attachmentDtoCheck.getType())) {
